...
const About = () => {
  ...
  const experiences = [
    {
      title: 'React JS Developer Developer',
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 mb-24">
          ...
          <div className="relative">
            ...
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 p-1">
              <div className="w-full h-full rounded-full overflow-hidden bg-gray-800">
                ...
                <div className="w-full h-full bg-gray-700 flex items-center justify-center text-center text-5xl font-bold text-white">
                    Akanksha Jagtap
                  </div>
        ...
        >
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            I'm Akanksha Jagtap, a passionate software developer specializing in creating responsive and user-friendly web applications. With expertise in React.js, JavaScript, and modern frontend technologies, I focus on developing scalable and performant applications that provide an exceptional user experience.
          </p>
