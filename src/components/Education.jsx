...
const ContactEducationPage = () => {
  ...
  const education = {
    ...
    duration: "2020 - 2023",
    percentage: "64%",
    details: "Completed Bachelor's degree with focus on computer science fundamentals, programming languages, and web development technologies."
  };
  ...
  const certifications = [
    {
      ...
      issuer: "Orenge Itech",
      year: "2023",
      details: "Comprehensive training in React.js development including components, state management, hooks, and advanced patterns."
    },
    {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-800/50 rounded-xl p-6 shadow-lg border border-gray-700">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-xl font-semibold text-cyan-400">{education.degree}</h4>
                <p className="text-gray-300">{education.institution}</p>
                <div className="flex justify-between mt-2">
                  <span className="text-gray-400">{education.duration}</span>
                  <span className="text-cyan-500 font-medium">{education.percentage}</span>
                </div>
                <p className="mt-3 text-gray-400">{education.details}</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              {certifications.map((cert, index) => (
                <div key={index} className="border-l-2 border-cyan-500 pl-4">
                  ...
                  <p className="mt-2 text-gray-400">{cert.details}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["JavaScript", "React.js", "HTML5", "CSS3", "Tailwind CSS", "Redux", "Git", "Node.js", "REST APIs", "Responsive Design"].map((skill, index) => (
              <span
                key={index}
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:contact@yourportfolio.com" className="text-base text-gray-100 hover:text-cyan-400 transition">
                    akankshajagtap13@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="tel:+1234567890" className="text-base text-gray-100 hover:text-cyan-400 transition">
                      +9022157620
                    </a>
                  </div>
                </div>
      ...
      <footer className="bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* About Section */}
            <div>
              <h3 className="text-xl font-bold mb-4 text-cyan-400">Your Name</h3>
              <p className="text-gray-300 mb-4">
                A passionate developer focused on creating beautiful and functional web experiences.
              </p>
              <div className="flex space-x-4">
                <a href="https://github.com/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-cyan-400 transition">
                  <Github className="h-5 w-5" />
                </a>
                <a href="https://linkedin.com/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-cyan-400 transition">
                  <Linkedin className="h-5 w-5" />
                </a>
          ...
          <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© {new Date().getFullYear()} Akanksha Jagtap All rights reserved.</p>
