...
const Hero = () => {
  ...
  const phoneNumber = "+91 9022157620";
  const email = "akankshajagtap13@gmail.com";
  
  useEffect(() => {
    const options = {
      strings: ['Software Developer', 'React.js Developer', 'Frontend Engineer', 'UI Developer'],
      typeSpeed: 70,
      backSpeed: 50,
      backDelay: 1500,
      loop: true,
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="text-center">
          ...
          >
            Passionate about creating responsive and user-friendly web applications with modern frameworks.
          </motion.p>
          ...
          >
            <div className="flex justify-center space-x-6">
              ...
              <a 
                href="https://www.linkedin.com/in/akanksha-jagtap-78673b27a" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-gray-400 hover:text-white transition-colors duration-300 transform hover:scale-110"
              >
      ...
      {/* <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2">
        <motion.div
          ...
          className="w-8 h-12 rounded-full border-2 border-cyan-500 flex justify-center pt-1 group hover:border-purple-400 transition-colors duration-300"
        >
          <motion.div
            animate={{ height: [0, 8, 0] }}
            transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
            className="w-1 bg-cyan-500 rounded-full group-hover:bg-purple-400 transition-colors duration-300"
          />
        </motion.div>
      </div> */}
    </div>
